            ...
            <div class="row mb-0">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Manajemen Keperluan</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            ...
                            <a href="{{ route('purpose.create') }}" class="btn btn-light btn-sm float-right"
                                style="color:black !important">
                                <i class="fas fa-plus mr-1"></i> Keperluan Baru
                            </a>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered table-striped purposesTable">
