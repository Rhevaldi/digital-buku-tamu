                        ...
                        <form action="{{route('tamu.store')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="radio" name="keperluan" value="Mengirim Surat" onclick="toggleKeperluan('surat')" > Mengirim Surat
					                <input type="radio" name="keperluan" value="Kunjungan" onclick="toggleKeperluan('kunjungan')"> Kunjungan<br>
                                      @error('keperluan')
                                    <p class="text-sm text-danger ">
                                        {{ $message }}
                                    </p>
