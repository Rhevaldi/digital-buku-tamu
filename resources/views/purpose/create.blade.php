            ...
            <div class="row mb-0">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Keperluan Baru</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name') }}" placeholder="Masukkan jenis/nama keperluan" required
                                        autofocus>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                        placeholder="Masukkan deskripsi keperluan" required>{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
